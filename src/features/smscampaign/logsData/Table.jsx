...
const{smsCampaign:{tableData}}=jsondata;
        ...
        <table className="table w-full">
          <thead>
            ...
            >
              ...
              <th className="normal-case">Campaign Title</th>
              <th className="normal-case">Scheduled Date</th>
              <th className="normal-case">Scheduled Time</th>
              <th className="normal-case">SMS Sent</th>
              <th className="normal-case">SMS Delivered</th>
              <th className="normal-case">Delivered %</th>
              <th className="normal-case">Clicked</th>
              <th className="normal-case">Clicked %</th>
              <th className="normal-case">Login</th>
              <th className="normal-case">Login %</th>
          ...
          <tbody>
            {visibleData.map((u, k) => (
              ...
              >
                ...
                <td>{`${u.deliveredPercent}%`}</td>
                <td>{u.clicked}</td>
                <td>{`${u.clickedPercent}%`}</td>
                <td>{u.login}</td>
                <td>{`${u.loginPercent}%`}</td>
                <td>{u.description}</td>
              </tr>
            ))}
          </tbody>
