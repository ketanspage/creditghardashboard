...
const {library:{smsTable}}=jsondata
...
function UserChannels() {
    ...
    return (
      <TitleCard title={"Content library-sms"} className="rounded-t-none" topMargin="mt-2" TopSideButtons={<TopSideButtons applySearch={applySearch} applyFilter={applyFilter} removeFilter={removeFilter}/>}>
