...
const {campaignFunnelDashboard:{tableData}}=jsondata
...
function UserChannels() {
    ...
    return (
      <TitleCard title={"Content library"}  topMargin="mt-2" TopSideButtons={<TopSideButtons applySearch={applySearch} applyFilter={applyFilter} removeFilter={removeFilter}/>}>
