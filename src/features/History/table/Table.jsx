...
function UserChannels() {
  const{historyTableData}=jsondata 
  ...
  const visibleData = historyTableData.slice(
    startIndex,
    startIndex + itemsPerPage
  );

  const totalPages = Math.ceil(historyTableData.length / itemsPerPage);
    ...
    >
      ...
      <div className="overflow-x-auto">
        <table className="table w-full">
          <thead>
            <tr
              style={{ backgroundColor: "", color: "grey", cursor: "pointer" }}
            >
              <th></th>

              <th className="normal-case">Title</th>
              <th className="normal-case"> Date</th>
              <th className="normal-case">Total Count</th>
              <th className="normal-case">Success Count</th>
